...
### RN-002 — Inexistência de Caching em Tela (Local Storage)
...
### RN-003 — Armazenamento de Texto Longo
...
### RN-004 — Autenticação Administrativa Segura (JWT)
...
### RN-005 — Filtro de Exibição de Dados Públicos
...
### RN-006 — Pesquisa Unificada de Fila de Trabalho
...
### RN-007 — Calculadora de Score por Média Ponderada Normalizada
...
### RN-008 — Faixas Fixas de Classificação de Prioridade
...
### RN-009 — Parametrização Inicial de Pesos
...
### RN-011 — Manutenção de Custódia e Inativação Sem Bloqueios (Softlocks)
...
### RN-012 — Registro Manual e Independente de Mapeamento
...
### RN-013 — Bootstrapping e Seed de Fábrica do Super-Admin
...
### RN-014 — Geração Obrigatória de Logs de Auditoria
